  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.code === 'auth/operation-not-allowed') {
        setError('Email/Password sign-in is disabled in your Firebase Console. Please sign in with Google or enable "Email/Password" under Firebase Console > Authentication > Sign-in method.');
      } else if (!isRegistering && (err.code === 'auth/user-not-found' || err.code === 'auth/invalid-credential')) {
        if (email === 'nkhiangte@gmail.com') {
          try {
            ...
            if (createErr.code === 'auth/operation-not-allowed') {
              setError('Email/Password sign-in is disabled in Firebase Console. Use Google Sign-In or enable "Email/Password" in Firebase Console > Authentication > Sign-in method.');
            } else {
      ...
      <div className="bg-white rounded-[32px] w-full max-w-sm shadow-xl border border-[#e0e0d5] overflow-hidden">
        ...
        <div className="p-6 space-y-4 font-sans">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-[#ecece0] text-stone-700 py-3 rounded-xl text-xs font-semibold hover:bg-stone-50 transition shadow-sm"
          >
          ...
          <div className="relative flex items-center justify-center my-2">
            <div className="border-t border-[#ecece0] w-full"></div>
            <span className="bg-white px-3 text-[10px] uppercase font-bold text-stone-400 tracking-wider absolute">or</span>
          </div>
